...
(function () {
  ...
  angular.module('jukebox', ['ngRoute', 'ngAnimate', 'ui.bootstrap', 'as.sortable', 'ngTouch', 'ngCookies', 'matchMedia', 'spotify']).directive('compile', ["$compile", "$timeout", function ($compile, $timeout) {
    return {
      restrict: 'A',
...
(function () {
  ...
  graphControlsController.$inject = ["$scope"];
})();
'use strict';
...
(function () {
  ...
  graphController.$inject = ["$scope", "$http"];
})();
'use strict';
...
(function () {
  ...
  angular.module('jukebox').directive('header', header).filter('spotifyEmbedUrl', ["$sce", function ($sce) {
...
(function () {
  ...
  angular.module('jukebox').controller('QueueController', ["$scope", "$rootScope", "$interval", "$routeParams", "$cookies", "$uibModal", "backendAPI", "sharedRoomData", "screenSize", function ($scope, $rootScope, $interval, $routeParams, $cookies, $uibModal, backendAPI, sharedRoomData, screenSize) {
...
(function () {
  ...
  datavizController.$inject = ["$scope", "$http", "$timeout", "Spotify"];
})();
'use strict';
