...
(function () {
  ...
  angular
    .module('jukebox')
    .controller('QueueController', ["$scope", "$rootScope", "$interval", "$routeParams", "$cookies", "$uibModal", "backendAPI", "sharedRoomData", "screenSize", function($scope, $rootScope, $interval, $routeParams, $cookies, $uibModal, backendAPI, sharedRoomData, screenSize) {
